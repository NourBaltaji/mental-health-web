    ...
    <div className="landing-page">
      <div>
        <img
          ...
          src="https://cdn.pixabay.com/photo/2016/11/28/21/20/happiness-1866081_960_720.jpg"
        ...
        <div className="transparent-backg">
          ...
          <div className="container">
            <img
              ...
              src="https://icon-library.com/images/brain-icon-png/brain-icon-png-23.jpg"
              alt="brain-icon"
            />
            <p className="work-font">
              <b>
                YOUR MENTAL HEALTH <br></br> &emsp; IS IMPORTANT.
              </b>
            </p>
            <p className="centred-text">
              <b>
                &emsp; &ensp; KNOW <br></br> WHAT WORKS<br></br>&emsp; FOR YOU.
              </b>
            </p>
            <p className="work-font">
